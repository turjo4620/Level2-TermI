...
cout << "\n                         HASH TABLE PERFORMANCE REPORT                   \n";
    ...
    cout << left << setw(20) << " " 
         << setw(22) << "Number of Collisions" << setw(18) << "Average Hits" 
         << setw(22) << "Number of Collisions" << setw(18) << "Average Hits" << endl;


    cout << left << setw(20) << "Chaining Method" 
         << setw(22) << collision_chain_hash1 << fixed << setprecision(4) << setw(18) << average_hits_chain_hash1 
         << setw(22) << collision_chain_hash2 << fixed << setprecision(4) << setw(18) << average_hits_chain_hash2 << endl;

    cout << left << setw(20) << "Double Hashing" 
         << setw(22) << collision_double_hashing_hash1 << fixed << setprecision(4) << setw(18) << average_hits_double_hash1 
         << setw(22) << collision_double_hashing_hash2 << fixed << setprecision(4) << setw(18) << average_hits_double_hash2 << endl;

    cout << left << setw(20) << "Custom Probing" 
         << setw(22) << collision_custom_probing_hash1 << fixed << setprecision(4) << setw(18) << average_hits_custom_hash1 
         << setw(22) << collision_custom_probing_hash2 << fixed << setprecision(4) << setw(18) << average_hits_custom_hash2 << endl;
